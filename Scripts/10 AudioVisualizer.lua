...
audioVisualizer.defaultIntervals = {0, 19.0, 35, 45, 60, 75, 90, 110, 140, 180, 240, 330, 400, 500, 600, 700, 800, 1200, 1300, 1500, 1600, 1800, 2200, 2400, 2600, 3000, 3300, 3900, 4500, 4800, 5000, 5200}
...
function audioVisualizer:new(params)
    ...
    do
        ...
        local width = (params.width - intCount * params.spacing + 350) / (#freqIntervals - 2)
